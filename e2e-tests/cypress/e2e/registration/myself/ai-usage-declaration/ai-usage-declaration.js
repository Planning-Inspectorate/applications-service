...
import PO_AiUsageDeclaration from './PageObjects/PO_AiUsageDeclaration';
...
Then('I am on the {string} page', (pageName) => {
	if (pageName.toLowerCase() === 'ai usage declaration') {
		aiUsageDeclaration.assertOnPage(pageName);
		return;
	}

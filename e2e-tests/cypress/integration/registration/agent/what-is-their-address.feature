...
Feature: UK Address details page
    ...
    I want to provide representee address details
    So that I can register on their behalf as an interested party

    Background: Start registration as an agent and progress to representee postal address page
    ...
    Scenario: User continues with all data beyond the max length constraints
        When I continue with the following values in the representee address fields

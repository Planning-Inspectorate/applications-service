...
} = require('../../../../../src/controllers/examination/submission-error/utils/handleProcessSubmissionRetry');
...
jest.mock(
	'../../../../../src/controllers/examination/submission-error/utils/handleProcessSubmissionRetry',
	() => ({
			...
			describe('and there are no errors', () => {
				...
				it('should return the page template and page data', () => {
					expect(res.render).toHaveBeenCalledWith(
						'error/examination-submission-error',
						mockPageDataValue
					);
				});
			});

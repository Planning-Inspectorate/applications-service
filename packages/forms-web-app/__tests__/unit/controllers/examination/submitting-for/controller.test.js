const {
	getSubmittingFor,
	postSubmittingFor
} = require('../../../../../src/controllers/examination/submitting-for/controller');
...
const {
	getRedirectUrl
} = require('../../../../../src/controllers/examination/submitting-for/utils/get-redirect-url');
const {
	setDeadlineDetailsSubmittingFor
} = require('../../../../../src/controllers/examination/session/deadline');

jest.mock('../../../../../src/controllers/examination/submitting-for/utils/get-page-data', () => ({
	getPageData: jest.fn()
}));
jest.mock(
	'../../../../../src/controllers/examination/submitting-for/utils/get-redirect-url',
	() => ({
...
describe('controllers/examination/submitting-for/controller', () => {
	const req = {
		body: {},
		session: { examination: {} },
		query: { mock: 'query' }

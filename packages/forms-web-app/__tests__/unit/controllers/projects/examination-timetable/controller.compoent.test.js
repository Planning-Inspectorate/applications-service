...
} = require('../../../../../src/controllers/projects/examination-timetable/controller');
...
describe('controllers/projects/examination-timetable/controller', () => {
		...
		describe('When getting the examination table page', () => {
			describe('and there are no issues', () => {
				...
				it('should call the correct template with the page data', async () => {
					expect(res.render).toHaveBeenCalledWith('projects/examination-timetable', {
	...
	describe('#postExaminationTimetable', () => {
		...
		it('should render a not found page for missing events', async () => {
			...
			await postExaminationTimetable(req, mockRes);

...
<html lang="{{ htmlLang | default('en') }}" class="govuk-template {{ htmlClasses }}">
  ...
  <body class="beans govuk-template__body {{ bodyClasses }}" {%- for attribute, value in bodyAttributes %} {{attribute}}="{{value}}"{% endfor %}>
...
{# This has been edited to allow a contents block on the side of the main container #}
    {% block main %}
      <div class="govuk-width-container {{ containerClasses }}">
        ...
        {% if hasContentsAside %}
          <div class="pins-pane-width">
          {% block contentsAside %}{% endblock %}
        {% endif %}

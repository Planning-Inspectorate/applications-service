...
} = require('./add-representations-index-translations-middleware');
...
describe('pages/projects/representations/index/_middleware/add-representations-index-translations-middleware.js', () => {
	describe('#addRepresentationsIndexTranslationsMiddleware', () => {
		const req = {
			i18n: {
				language: null,
		...
		describe('When the language is set to English', () => {
			beforeEach(() => {
				...
				addRepresentationsIndexTranslationsMiddleware(req, res, next);
			});

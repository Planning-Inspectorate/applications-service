...
describe('pages/projects/register/agent/their-email/_utils/get-redirect-url', () => {
	describe('#getRedirectURL', () => {
		...
		describe('When the user is NOT in edit mode', () => {
			...
			it('should return the register agent their address url', () => {
				expect(redirectURL).toEqual('/projects/mock-case-ref/register/agent/their-postal-address');
			});
		});
	});
});

...
describe('registerStartRedirectMiddleware', () => {
		...
		describe('and there is no query string', () => {
			it('should redirect to the register index URL', () => {
				const req = {
					session: {},
					query: {},
					originalUrl: '/projects/ABC-123/register/registering-for'
				};
		...
		describe('and there is a query string', () => {
			it('should redirect and preserve the query string', () => {
				const req = {
					session: {},
					query: { lang: 'cy' },
					originalUrl: '/projects/ABC-123/register/registering-for?lang=cy'
				};
	...
	describe('Case reference extraction', () => {
		it('should correctly extract the caseRef from the URL', () => {
			const req = {
				session: {},
				query: {},
				originalUrl: '/projects/EN012345/register/some-step'
			};
			...
			const expectedIndexUrl = getRegisterIndexURL('EN012345');

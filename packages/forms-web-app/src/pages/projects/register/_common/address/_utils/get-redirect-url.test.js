...
describe('pages/projects/register/_common/address/_utils/get-redirect-url', () => {
	describe('#getRedirectURL', () => {
		...
		describe('When the user has previously selected registering for agent', () => {
			...
			describe('and the user is NOT in edit mode', () => {
				...
				it('should return the register agent number page', () => {
					expect(redirectURL).toEqual('/projects/mock-case-ref/register/agent/telephone-number');
				});
			});
		});
		...
		describe('When the user has previously selected registering for myself', () => {
			...
			describe('and the user is NOT in edit mode', () => {
				...
				it('should return the register myself number page', () => {
					expect(redirectURL).toEqual('/projects/mock-case-ref/register/myself/telephone-number');
				});
			});
		});
		...
		describe('When the user has previously selected registering for organisation', () => {
			...
			describe('and the user is NOT in edit mode', () => {
				...
				it('should return the register organisation number page', () => {
					expect(redirectURL).toEqual(

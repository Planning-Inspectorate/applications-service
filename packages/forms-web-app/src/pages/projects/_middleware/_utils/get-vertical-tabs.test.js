...
jest.mock('../../register/index/_utils/is-registration-open', () => ({
	isRegistrationOpen: jest.fn()
}));

describe('#getVerticalTabs', () => {
	describe('When getting the vertical tabs for the projects layout', () => {
		describe('and the registration period is closed', () => {
			...
			beforeEach(() => {
				...
				isRegistrationOpen.mockResolvedValue(false);
			});

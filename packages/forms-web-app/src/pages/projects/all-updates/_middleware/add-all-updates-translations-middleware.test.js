...
} = require('./add-all-updates-translations-middleware');
...
describe('pages/projects/all-updates/_middleware/add-all-updates-translations-middleware', () => {
	describe('#addProjectsAllUpdatesTranslationsMiddleware', () => {
		const req = {
			i18n: {
				language: null,
		...
		describe('When the language is set to English', () => {
			beforeEach(() => {
				...
				addProjectsAllUpdatesTranslationsMiddleware(req, res, next);
			});

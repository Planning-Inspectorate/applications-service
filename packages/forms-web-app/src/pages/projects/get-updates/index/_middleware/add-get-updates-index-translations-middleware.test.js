...
} = require('./add-get-updates-index-translations-middleware');
...
describe('pages/projects/get-updates/index/_middleware/add-get-updates-index-translations-middleware', () => {
	describe('#addGetUpdatesIndexTranslationsMiddleware', () => {
		const req = {
			i18n: {
				language: null,
		...
		describe('When the language is set to English', () => {
			beforeEach(() => {
				...
				addGetUpdatesIndexTranslationsMiddleware(req, res, next);
			});

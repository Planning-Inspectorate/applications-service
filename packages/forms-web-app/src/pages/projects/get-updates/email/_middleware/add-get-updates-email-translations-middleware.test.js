...
} = require('./add-get-updates-email-translations-middleware');
...
describe('pages/projects/get-updates/email/_middleware/add-get-updates-email-translations-middleware', () => {
	describe('#addGetUpdatesEmailTranslationsMiddleware', () => {
		const req = {
			i18n: {
				language: null,
		...
		describe('When the language is set to English', () => {
			beforeEach(() => {
				...
				addGetUpdatesEmailTranslationsMiddleware(req, res, next);
			});

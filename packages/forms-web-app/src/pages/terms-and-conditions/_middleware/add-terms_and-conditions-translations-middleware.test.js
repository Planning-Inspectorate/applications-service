...
} = require('./add-terms-and-conditions-translations-middleware');
...
describe('pages/terms-and-conditions/_middleware/add-terms-and-conditions-translations-middleware', () => {
	describe('#addTermsAndConditionsTranslationsMiddleware', () => {
		const req = {
			i18n: {
				language: null,
		...
		describe('When the language is set to English', () => {
			beforeEach(() => {
				...
				addTermsAndConditionsTranslationsMiddleware(req, res, next);
			});

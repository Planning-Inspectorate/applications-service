const { getProjectCaseRef } = require('../../../controllers/projects/utils/get-project-case-ref');
const { getEvents } = require('./events/get-events');
const { getExamination } = require('./examination/get-examination');
const { getProjectName } = require('../../../controllers/projects/utils/get-project-name');

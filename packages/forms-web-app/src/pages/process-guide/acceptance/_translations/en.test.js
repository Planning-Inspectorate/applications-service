...
describe('pages/process-guide/acceptance/_translations/en', () => {
	it('should return the english process guide acceptance page translations', () => {
		expect(enAcceptanceTranslations).toEqual({
			...
			paragraph1:
				'The applicant sends us their application at this stage. The application must include all the required documents as set out in legislation. We look at the documents to check if we can accept the application for examination. We have 28 days to make this decision.',

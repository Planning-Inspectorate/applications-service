...
const { validTypeOfPartyOptions } = require('./type-of-party.validator');
const { REGISTER } = require('../../../constants');

const view = 'register/who-are-you-registering-for/who-registering-for.njk';
exports.getTypeOfParty = (req, res) => {
	res.render(view, { type: req.session.typeOfParty });
};

const enExaminationHaveYourSayTranslations = require('./en.json');

describe('pages/examination/have-your-say/_translations/en', () => {
	it('should return the English examination have your say page translations', () => {
		expect(enExaminationHaveYourSayTranslations).toEqual({
			common: {
			...
			deadlinesOpen: {
				...
				paragraph1:
					"We'll ask for your personal details and your examination comments about this project.",
				...
				paragraph4:
					"If you have not registered as an interested party, we'll ask you for your personal details and documents to support your comments if you plan to upload them.",

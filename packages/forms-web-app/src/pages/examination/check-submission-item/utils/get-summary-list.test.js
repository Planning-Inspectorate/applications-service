const { getSummaryList } = require('./get-summary-list');
...
jest.mock('./summary-list-item/personal-information-which/is-valid', () => ({
...
describe('examination/enter-comment/utils/get-summary-list', () => {

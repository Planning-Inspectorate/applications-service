...
describe('pages/examination/_middleware/examination.middleware', () => {
	describe('#examinationMiddleware', () => {
		...
		describe('When the user has navigated from within the examination journey', () => {
			describe('and the user does not have an examination session', () => {
				it('should render the session expired error page', () => {
					const req = {
						get: jest
							.fn()
							.mockReturnValue('/projects/ABC-123/examination/have-your-say-during-examination'),
					...
					const next = jest.fn();
					const indexURL = `/projects/ABC-123/examination/have-your-say-during-examination`;
		...
		describe('When the user has navigated from outside the examination journey', () => {
			describe('and the user does not have an examination session', () => {
				describe('and there are no query values present', () => {
					const req = {
						get: jest.fn().mockReturnValue('/projects/ABC-123'),
						path: '/have-an-interested-party-number',
						params: {
		...
		describe('When the user is viewing an examination journey page and does have an examination session', () => {
			const req = {
				get: jest
					.fn()
					.mockReturnValue('/projects/ABC-123/examination/have-your-say-during-examination'),

...
describe('pages/have-your-say-guide/registering/_translations/cy', () => {
	it('should return the welsh have your say guide registering translations', () => {
		expect(cyRegisteringTranslations).toEqual({
			...
			heading4: 'Cofrestru i leisio’ch barn',
			...
			paragraph5:
				'Byddwn yn cyhoeddi eich enw a’ch sylwadau ar ein gwefan. Byddwn yn cadw eich cyfeiriad cartref, eich cyfeiriad e-bost a’ch rhif ffôn yn breifat. {{-link}} i gael rhagor o wybodaeth.',
			paragraph5LinkText: 'Darllenwch ein hysbysiad preifatrwydd',
			paragraph6:

...
} = require('./add-have-your-say-guide-translations-middleware');
...
describe('pages/have-your-say-guide/_middleware/add-have-your-say-guide-translations-middleware', () => {
	describe('#addHaveYourSayGuideTranslationsMiddleware', () => {
		const req = {
			i18n: {
				language: null,
		...
		describe('When the language is set to English', () => {
			beforeEach(() => {
				...
				addHaveYourSayGuideTranslationsMiddleware(req, res, next);
			});

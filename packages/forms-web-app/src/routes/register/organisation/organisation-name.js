...
const organisationNameController = require('../../../controllers/register/organisation/organisation-name');
const { validationErrorHandler } = require('../../../validators/validation-error-handler');
const {
  rules: organisationNameValidationRules,
} = require('../../../validators/register/organisation/organisation-name');

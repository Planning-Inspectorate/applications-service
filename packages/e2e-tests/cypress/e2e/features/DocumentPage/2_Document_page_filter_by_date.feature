...
Scenario: 1 - View date filter
When The user enters a date in the From filter in the Date published 
And Clicks Apply filter 
Then A filtered results section is displayed with the date from active filter
And A list of documents that were published from 1 1 2023 until the current date are displayed, newest first

...
Then('I complete the submission process as an organisation - drag-drop & comment', () => {
	examTimetable.startNowButton();
	examTimetable.partyNumberYesCheckBox();
	cy.continueButton();
	examTimetable.partyNumberField().type('45677');
	cy.continueButton();
	examTimetable.organizationCheckBox(); // Submission a Organization
	cy.continueButton();
	...
	examTimetable
		.fileUploadButton()
		.selectFile('cypress/fixtures/Cypress.docx', { action: 'drag-drop' }); // Drag and drop

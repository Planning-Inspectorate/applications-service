Feature: User Completes submission of examination timetable for a national infrastructure project
  ...
  Scenario: 1 - User completes submission of examination timetable process as myself - drag and drop
  ...
  Scenario: 2 - User completes submission of examination timetable process as a agent - drag and drop
  ...
  Scenario: 3 - User completes submission of examination timetable process as an organisation - drag and drop
